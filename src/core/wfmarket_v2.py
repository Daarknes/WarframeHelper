...
_section_market.addEntry("MAX_ORDER_AGE", 4, "Only include orders of players that are either in-game, or that have been updated in the last X hours")
_section_market.addEntry("MAX_UPDATE_AGE", 8, "The local market data (the prices) gets updated after this amount of hours")
